...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'project.authentication.JSONWebTokenAuthentication',
    ),
    'DEFAULT_PAGINATION_CLASS': 'project.utils.CustomPageNumberPagination',
    'PAGE_SIZE': 10,
...
JWT_AUTH = {
    ...
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'project.authentication.jwt_response_payload_handler',
